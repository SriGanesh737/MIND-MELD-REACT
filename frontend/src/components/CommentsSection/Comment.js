  ...
  return (
    ...
    <div className={`${isReply && Styles["single-reply"]} ${Styles["comment-container"]} ${user._id===comment_info.user_id?Styles["your-comment"]:" "}`}>
              ...
              <div className={Styles["right-part"]}>
                <div className={Styles["comment-header"]}> <a href={"/user/"+comment_info.user_id}> <img className={`${Styles["comment-profile-image"]} rounded-circle`} src={comment_info.profile_image_link}
                    alt=""/></a>
