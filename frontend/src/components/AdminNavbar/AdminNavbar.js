...
const AdminNavbar=()=>{
    ...
    <nav >
        <button className={styles.toggler} onClick={toggleNavbar}><i class='fa-solid fa-bars' ></i></button>
        ...
        <ul className={styles['nav-items']}>
         ...
         <Link to="/admin/mail" style={{textDecoration: "none",color: "white"}}> <li className={styles['nav-item']}><i class="fa-solid fa-envelope"></i><span className={styles[navitemspan]}>Mail</span></li></Link>
         <Link to="/logout" style={{textDecoration: "none",color: "white"}}> <li className={styles['nav-item']}><i class="fa-solid fa-right-from-bracket"></i><span className={styles[navitemspan]}>Logout</span></li></Link>        
        </ul>
    </nav>
</div>
    )
